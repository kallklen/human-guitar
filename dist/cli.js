...
var emitSuccess = function emitSuccess(message) {
    return console.log((0, _safe.green)(' \u2714 Sucesso: ' + message));
};
...
function cli(args) {
    (0, _guitar2.default)(args).then(function () {
        emitSuccess(args.sms ? 'sms enviado!' : 'chamada efetuada!');
    }).catch((0, _ramda.pipe)((0, _ramda.prop)('message'), emitError));
}

cli(_yargs2.default.usage('Uso: human-guitar --de=<de> --para=<para>').option('token', {
